...
\begin{document}
\activarfondo{Fotos_CPD/CPD_3.jpg}
...
% Activar fondo global a partir de aquí
\activarfondo{Fotos_CPD/CPD_3.jpg}
...
\desactivarlogoradiante{}
% ==========================================
\section{Demostración de Código y Fondo}
% ==========================================

% Desactivar fondo para esta diapositiva y las siguientes
\desactivarfondo

\begin{frame}[fragile]
\frametitle{Inclusión de fragmentos de código}
Ejemplo de código Bash con resaltado de sintaxis:

\vspace{0.3cm}
\begin{lstlisting}[style=terminal]
# Actualizar repositorios e instalar paquetes
sudo apt update
sudo apt install qiskit python3-pip
...
\end{thebibliography}
\end{frame}
\activarfondo{Fotos_CPD/CPD_2.jpg}
% --- DIAPOSITIVA FINAL ---
\begin{frame}
\begin{center}
